/**
 * ECHO Personal WhatsApp Auto-Sync Bot (ES Module Version .js)
 * Uses message_create event to capture ALL messages without triggering Vite HMR page refresh
 */
...
client.on('ready', () => {
  ...
  console.log('👉 Captured live without causing browser page refreshes!\n');
});
